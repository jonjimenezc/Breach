const strings = {
  es: {
    ...
    mS1Title: 'Loader ASI',
    mS1: [
      { strong: 'Compatible con mods de autos del ModLoader clasico', text: ' - los mods existentes funcionan normalmente.' },
      { strong: 'Soporte para el esquema de carpetas tradicional de ModLoader', text: '.' },
      { strong: 'Nueva estructura de carpetas Breach', text: ' - organizacion nueva opcional.' },
      { strong: 'Transicion amigable para usuarios existentes', text: '.' }
    ],
    mS2Title: 'Manager integrado',
    mS2: [
      { strong: 'Importa mods desde RAR o carpeta', text: ' - importar desde carpeta es mas seguro y recomendado; RAR tambien es compatible.' },
      { strong: 'Activa y desactiva mods con un clic', text: ' - sin editar archivos manualmente.' },
      { strong: 'Historial completo de mods', text: ' - lleva el control de todo lo que tiene instalado.' },
      { strong: 'Dos themes: Red y Black', text: ' - mismo lenguaje de diseno que Breach.' },
      { strong: 'Instalacion sencilla', text: ' - El manager ayuda con el proceso.' }
    ],
    mS3Title: 'Compatibilidad',
    mS3: [
    ...
    gS1Title: 'Ultimate ASI Loader',
    gS1: [
      { strong: 'Descargue la build de 32 bits', text: '' },
      { strong: 'Use primero la d3d9.dll', text: ' ' },
      { strong: 'Si d3d9.dll no funciona, renombrela a dinput8.dll', text: ' - tambien puede descargar la dinput8.dll directamente desde ese mismo release.' },
      { strong: 'Coloquelo en la raiz del juego', text: ' - el archivo debe quedar junto a speed.exe.' }
    ],
  ...
  en: {
    ...
    mS1Title: 'ASI Loader',
    mS1: [
      { strong: 'Compatible with classic ModLoader car mods', text: ' - existing mods work without any changes.' },
      { strong: 'Compatible with the traditional ModLoader folder scheme', text: '.' },
      { strong: 'Support for the new Breach folder structure', text: ' - optional new organization.' },
      { strong: 'Legacy-friendly transition path for existing users', text: '.' }
    ],
    mS2Title: 'Built-in Mod Manager',
    mS2: [
      { strong: 'Import mods from RAR or folder', text: ' - importing from folder is safer and recommended; RAR is also supported.' },
      { strong: 'Toggle mods on or off in one click', text: ' - no manual file editing required.' },
      { strong: 'Full mod history', text: ' - keep track of everything you have installed.' },
      { strong: 'Two themes: Red and Black', text: ' - same design language as Breach.' },
      { strong: 'Easy installation', text: ' - The manager helps with the process.' }
    ],
    ...
    gS1Title: 'Ultimate ASI Loader',
    gS1: [
      { strong: 'Download the 32-bit build', text: '' },
      { strong: 'Use d3d9.dll first', text: ' ' },
      { strong: 'If d3d9.dll does not work, rename it to dinput8.dll', text: ' - you can also download dinput8.dll directly from that same release.' },
      { strong: 'Place it in the game root', text: ' - the file should sit next to speed.exe.' }
    ],
...
const refs = {
  ...
  langEsButton: document.getElementById('btn-es'),
  langEnButton: document.getElementById('btn-en'),
  mEyebrow: document.getElementById('m-eyebrow'),
  mTitle: document.getElementById('m-title'),
  mS1Title: document.getElementById('m-s1-title'),
  mS2Title: document.getElementById('m-s2-title'),
  mS3Title: document.getElementById('m-s3-title'),
  gEyebrow: document.getElementById('g-eyebrow'),
  gTitle: document.getElementById('g-title'),
  gLinkPrefix: document.getElementById('g-link-prefix'),
  gLink: document.getElementById('g-link'),
  gS1Title: document.getElementById('g-s1-title'),
  gS2Title: document.getElementById('g-s2-title'),
  gS3Title: document.getElementById('g-s3-title')
};
...
function setLang(lang) {
  ...
  refs.mEyebrow.textContent = s.mEyebrow;
  refs.mTitle.textContent = s.mTitle;
  ...
  refs.gLink.textContent = s.gLink;
  refs.gS1Title.textContent = s.gS1Title;
  refs.gS2Title.textContent = s.gS2Title;
  refs.gS3Title.textContent = s.gS3Title;
  ...
  refs.langEsButton.classList.toggle('active', lang === 'es');
  refs.langEnButton.classList.toggle('active', lang === 'en');
...
function closeModal(overlay = activeModalOverlay) {
  if (!overlay) {
    return;
  }
...
refs.guideModalOverlay.addEventListener('click', handleOverlayClick);
